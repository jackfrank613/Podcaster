...
package com.tech_613.podcast.utils.bottom_nav_service;
...
public class BottomNavigationViewNew extends FrameLayout {
     ...
     * @param driver_background
     */
    @DrawableRes
    public int getItemBackgroundResource(int driver_background) {
    ...
    public void setSelectedItemId(@IdRes int itemId) {
        @SuppressLint("RestrictedApi") MenuItem item = mMenu.findItem(itemId);
        if (item != null) {
